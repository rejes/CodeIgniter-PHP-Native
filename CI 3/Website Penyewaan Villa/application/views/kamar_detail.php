          ...
          <div class="search-form"><h4><span class="fa fa-search"></span> Search for</h4>
              ...
              <div class="col-lg-12">
                  <select class="form-control" name="id_kelas_kamar">
                    <option value="">Pilih Kelas Villa</option>
                    <?php
...
<h3>Nomor Villa : <?php echo $no_kamar;?></h3>
<div class="row">
  <div class="col-lg-8">
...
<!-- #Slider Ends -->
  ...
  <div class="spacer"><h4><span class="fa fa-th-list"></span> Informasi Villa</h4>
...
<div class="enquiry">
  ...
  <h6><span class="fa fa-envelope"></span> Pemesanan Villa</h6>
  <?php echo form_open('welcome/reservasi/','role="form"'); ?>
    <input type="hidden" name="id_kamar" value="<?php echo $id_kamar;?>">
     <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
      ...
      <button type="submit" class="btn btn-primary" name="Submit">Booking Villa</button>
