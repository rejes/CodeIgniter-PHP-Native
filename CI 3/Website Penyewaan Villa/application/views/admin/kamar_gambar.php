        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <center>
                      <h3>Nomer Villa : <?php echo $no_kamar;  ?> </h3>
                      <h3>Harga Villa : <?php echo rupiah($harga_kamar); ?> </h3>
                      <h3>Kelas Villa : <?php echo $nama_kelas_kamar ?> </h3>
                      </center>
