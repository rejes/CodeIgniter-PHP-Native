            ...
            <div class="table-responsive">
              <form method="post" action="<?php echo base_url().'admin/kamar_tambah_aksi'; ?>">
                  <div class="form-group">
                      <label class="control-label col-md-3">Kelas Villa</label>
                      <div class="col-md-9">
                      <select name="id_kelas_kamar" class="form-control">
                        <option value="id_kelas_kamar">-Pilih Kelas Villa-</option>
