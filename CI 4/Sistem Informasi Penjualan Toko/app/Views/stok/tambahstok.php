...
<ol class="breadcrumb mx-4 bg-dark ">
    ...
    <li class="breadcrumb-item"><a href="/Stokmasuk" id="btn-back" class="text-white">Stok</a></li>
...
<div class="container-fluid ">
    <div class="card mb-3 ">
        ...
        <div class="card-body">
            <form action="/Stok/Stokmasuk/tambahstok" method="POST">
                <div class="row">
                    <div class="col-6">
                        <?php csrf_token(); ?>
                        <?php $timezone = time() + (60 * 60 * 7); ?>
                        <input type="hidden" class="pengguna-id" name="pengguna_id" value="<?= session()->get('id');?>">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select
                                class=" form-control  <?= ($validation->hasError('supplier')) ? 'is-invalid' : ''; ?> "
                                name="supplier">
                                <option value=" ">--pilih--</option>
                                <?php foreach ($supplier as $k) : ?>
                                <option value="<?= $k['id_supplier'] ?>">
                                    <?= $k['nama_supplier']; ?>
                                </option>
                                <?php endforeach; ?>
                            </select>
                            <div id="supplier" class="invalid-feedback text-left ml-1 mt-0">
                                <span> <?= $validation->getError('supplier'); ?>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="keterangan" class="invalid-feedback text-left ml-1 mt-0">
                                <span> <?= $validation->getError('keterangan'); ?>
                                </span>
                            </div>
                        </div>
        ...
        <div class="form-group ml-4">
            <a href="/Stokmasuk" id="btn-back" class="text-dark"><i class="fas fa-arrow-left"></i> Kembali</a>
        </div>
    </div>
</div>
